...
#define LOW_PRECISION`),e}function u1(s){let e="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===J_?e="SHADOWMAP_TYPE_PCF":s.shadowMapType===Q_?e="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===tr&&(e="SHADOWMAP_TYPE_VSM"),e}function h1(s){let e="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case vo:case xo:e="ENVMAP_TYPE_CUBE";break;case Uc:e="ENVMAP_TYPE_CUBE_UV";break}return e}function f1(s){let e="ENVMAP_MODE_REFLECTION";if(s.envMap)switch(s.envMapMode){case xo:e="ENVMAP_MODE_REFRACTION";break}return e}function d1(s){let e="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case ev:e="ENVMAP_BLENDING_MULTIPLY";break;case rS:e="ENVMAP_BLENDING_MIX";break;case sS:e="ENVMAP_BLENDING_ADD";break}return e}function p1(s){const e=s.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:i,maxMip:t}}function m1(s,e,t,i){const o=s.getContext(),a=t.defines;let c=t.vertexShader,u=t.fragmentShader;const f=u1(t),d=h1(t),g=f1(t),p=d1(t),_=p1(t),y=n1(t),E=i1(a),M=o.createProgram();let S,x,D=t.glslVersion?"#version "+t.glslVersion+`
