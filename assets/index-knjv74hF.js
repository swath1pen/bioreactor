 ...
 *
 * @license MIT
 */function uf(){return uf=Object.assign?Object.assign.bind():function(s){for(var e=1;e<arguments.length;e++){var t=arguments[e];for(var i in t)Object.prototype.hasOwnProperty.call(t,i)&&(s[i]=t[i])}return s},uf.apply(this,arguments)}function My(s,e){if(s==null)return{};var t={},i=Object.keys(s),o,a;for(a=0;a<i.length;a++)o=i[a],!(e.indexOf(o)>=0)&&(t[o]=s[o]);return t}function Ey(s){return!!(s.metaKey||s.altKey||s.ctrlKey||s.shiftKey)}function Ty(s,e){return s.button===0&&(!e||e==="_self")&&!Ey(s)}const wy=["onClick","relative","reloadDocument","replace","state","target","to","preventScrollReset","viewTransition"],Ay="6";try{window.__reactRouterVersion=Ay}catch{}const Ry="startTransition",cg=Ex[Ry];function by(s){let{basename:e,children:t,future:i,window:o}=s,a=Ie.useRef();a.current==null&&(a.current=Px({window:o,v5Compat:!0}));let c=a.current,[u,f]=Ie.useState({action:c.action,location:c.location}),{v7_startTransition:d}=i||{},g=Ie.useCallback(m=>{d&&cg?cg(()=>f(m)):f(m)},[f,d]);return Ie.useLayoutEffect(()=>c.listen(g),[c,g]),Ie.useEffect(()=>xy(i),[i]),Ie.createElement(yy,{basename:e,children:t,location:u.location,navigationType:u.action,navigator:c,future:i})}const Cy=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u",Py=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,xc=Ie.forwardRef(function(e,t){let{onClick:i,relative:o,reloadDocument:a,replace:c,state:u,target:f,to:d,preventScrollReset:g,viewTransition:m}=e,_=My(e,wy),{basename:y}=Ie.useContext(xs),M,E=!1;if(typeof d=="string"&&Py.test(d)&&(M=d,Cy))try{let P=new URL(window.location.href),R=d.startsWith("//")?new URL(P.protocol+d):new URL(d),U=nd(R.pathname,y);R.origin===P.origin&&U!=null?d=U+R.search+R.hash:E=!0}catch{}let S=iy(d,{relative:o}),x=Ly(d,{replace:c,state:u,target:f,preventScrollReset:g,relative:o,viewTransition:m});function D(P){i&&i(P),P.defaultPrevented||x(P)}return Ie.createElement("a",uf({},_,{href:M||S,onClick:E||a?i:D,ref:t,target:f}))});var ug;(function(s){s.UseScrollRestoration="useScrollRestoration",s.UseSubmit="useSubmit",s.UseSubmitFetcher="useSubmitFetcher",s.UseFetcher="useFetcher",s.useViewTransitionState="useViewTransitionState"})(ug||(ug={}));var hg;(function(s){s.UseFetcher="useFetcher",s.UseFetchers="useFetchers",s.UseScrollRestoration="useScrollRestoration"})(hg||(hg={}));function Ly(s,e){let{target:t,replace:i,state:o,preventScrollReset:a,relative:c,viewTransition:u}=e===void 0?{}:e,f=ry(),d=Nc(),g=K_(s,{relative:c});return Ie.useCallback(m=>{if(Ty(m,t)){m.preventDefault();let _=i!==void 0?i:Rc(d)===Rc(g);f(s,{replace:_,state:o,preventScrollReset:a,relative:c,viewTransition:u})}},[d,f,g,i,o,t,s,a,c,u])}const Dy=({onComplete:s})=>{const[e,t]=Ie.useState(""),i="<BioElectro>";return Ie.useEffect(()=>{let o=0;const a=setInterval(()=>{t(i.substring(0,o)),o++,o>i.length&&(clearInterval(a),setTimeout(()=>{s()},1e3))},100);return()=>clearInterval(a)},[s]),ve.jsxs("div",{className:"fixed inset-0 z-50 bg-black text-gray-100 flex flex-col items-center justify-center",children:[ve.jsxs("div",{className:"mb-4 text-4xl font-mono font-bold",children:[e," ",ve.jsx("span",{className:"animate-blink ml-1",children:" | "})]}),ve.jsx("div",{className:"w-[200px] h-[2px] bg-gray-800 rounded relative overflow-hidden",children:ve.jsx("div",{className:"w-[40%] h-full bg-blue-500 shadow-[0_0_15px_#3b82f6] animate-loading-bar"})})]})},Iy=({menuOpen:s,setMenuOpen:e})=>(Ie.useEffect(()=>{document.body.style.overflow=s?"hidden":""},[s]),ve.jsx("nav",{className:"fixed top-0 w-full z-40 bg-[rgba(10, 10, 10, 0.8)] backdrop-blur-lg border-b border-white/10 shadow-lg",children:ve.jsx("div",{className:"max-w-5xl mx-auto px-4",children:ve.jsxs("div",{className:"flex justify-between items-center h-16",children:[ve.jsxs(xc,{to:"/",className:"font-mono text-xl font-bold text-white",children:["BioEchem",ve.jsx("span",{className:"text-emerlad-300",children:"Builds"})]}),ve.jsx("div",{className:"w-7 h-5 relative cursor-pointer z-40 md:hidden",onClick:()=>e(t=>!t),children:"☰"}),ve.jsxs("div",{className:"hidden md:flex items-center space-x-8",children:[ve.jsx(xc,{to:"/",className:"text-gray-300 hover:text-white transition-colors",children:"Home"}),ve.jsx("a",{href:"#about",className:"text-gray-300 hover:text-white transition-colors",children:"Usage"}),ve.jsx("a",{href:"#projects",className:"text-gray-300 hover:text-white transition-colors",children:"Part List"}),ve.jsx(xc,{to:"/contact",className:"text-gray-300 hover:text-white transition-colors",children:"Model"})]})]})})})),Ny=({menuOpen:s,setMenuOpen:e})=>ve.jsxs("div",{className:`fixed top-0 left-0 w-full bg-[rgba(10,10,10,0.8)] z-40 flex flex-col items-center justify-center
...
`].filter(ya).join(`
`)),c=Jf(c),c=E_(c,t),c=T_(c,t),u=Jf(u),u=E_(u,t),u=T_(u,t),c=w_(c),u=w_(u),t.isRawShaderMaterial!==!0&&(D=`#version 300 es
...
`)+`
`+x);const P=D+S+c,R=D+x+u,U=y_(o,o.VERTEX_SHADER,P),z=y_(o,o.FRAGMENT_SHADER,R);o.attachShader(E,U),o.attachShader(E,z),t.index0AttributeName!==void 0?o.bindAttribLocation(E,0,t.index0AttributeName):t.morphTargets===!0&&o.bindAttribLocation(E,0,"position"),o.linkProgram(E);function O(F){if(s.debug.checkShaderErrors){const le=o.getProgramInfoLog(E)||"",ne=o.getShaderInfoLog(U)||"",ae=o.getShaderInfoLog(z)||"",he=le.trim(),se=ne.trim(),ue=ae.trim();let H=!0,oe=!0;if(o.getProgramParameter(E,o.LINK_STATUS)===!1)if(H=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(o,E,U,z);else{const ie=M_(o,U,"vertex"),N=M_(o,z,"fragment");console.error("THREE.WebGLProgram: Shader Error "+o.getError()+" - VALIDATE_STATUS "+o.getProgramParameter(E,o.VALIDATE_STATUS)+`
