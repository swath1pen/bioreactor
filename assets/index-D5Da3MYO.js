 ...
 *
 * @license MIT
 */function uf(){return uf=Object.assign?Object.assign.bind():function(s){for(var e=1;e<arguments.length;e++){var t=arguments[e];for(var i in t)Object.prototype.hasOwnProperty.call(t,i)&&(s[i]=t[i])}return s},uf.apply(this,arguments)}function Ey(s,e){if(s==null)return{};var t={},i=Object.keys(s),o,a;for(a=0;a<i.length;a++)o=i[a],!(e.indexOf(o)>=0)&&(t[o]=s[o]);return t}function My(s){return!!(s.metaKey||s.altKey||s.ctrlKey||s.shiftKey)}function Ty(s,e){return s.button===0&&(!e||e==="_self")&&!My(s)}const wy=["onClick","relative","reloadDocument","replace","state","target","to","preventScrollReset","viewTransition"],Ay="6";try{window.__reactRouterVersion=Ay}catch{}const Ry="startTransition",cg=Mx[Ry];function by(s){let{basename:e,children:t,future:i,window:o}=s,a=Ie.useRef();a.current==null&&(a.current=Px({window:o,v5Compat:!0}));let c=a.current,[u,f]=Ie.useState({action:c.action,location:c.location}),{v7_startTransition:d}=i||{},g=Ie.useCallback(m=>{d&&cg?cg(()=>f(m)):f(m)},[f,d]);return Ie.useLayoutEffect(()=>c.listen(g),[c,g]),Ie.useEffect(()=>xy(i),[i]),Ie.createElement(yy,{basename:e,children:t,location:u.location,navigationType:u.action,navigator:c,future:i})}const Cy=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u",Py=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,xc=Ie.forwardRef(function(e,t){let{onClick:i,relative:o,reloadDocument:a,replace:c,state:u,target:f,to:d,preventScrollReset:g,viewTransition:m}=e,_=Ey(e,wy),{basename:y}=Ie.useContext(xs),E,M=!1;if(typeof d=="string"&&Py.test(d)&&(E=d,Cy))try{let P=new URL(window.location.href),R=d.startsWith("//")?new URL(P.protocol+d):new URL(d),U=nd(R.pathname,y);R.origin===P.origin&&U!=null?d=U+R.search+R.hash:M=!0}catch{}let S=iy(d,{relative:o}),x=Ly(d,{replace:c,state:u,target:f,preventScrollReset:g,relative:o,viewTransition:m});function D(P){i&&i(P),P.defaultPrevented||x(P)}return Ie.createElement("a",uf({},_,{href:E||S,onClick:M||a?i:D,ref:t,target:f}))});var ug;(function(s){s.UseScrollRestoration="useScrollRestoration",s.UseSubmit="useSubmit",s.UseSubmitFetcher="useSubmitFetcher",s.UseFetcher="useFetcher",s.useViewTransitionState="useViewTransitionState"})(ug||(ug={}));var hg;(function(s){s.UseFetcher="useFetcher",s.UseFetchers="useFetchers",s.UseScrollRestoration="useScrollRestoration"})(hg||(hg={}));function Ly(s,e){let{target:t,replace:i,state:o,preventScrollReset:a,relative:c,viewTransition:u}=e===void 0?{}:e,f=ry(),d=Nc(),g=K_(s,{relative:c});return Ie.useCallback(m=>{if(Ty(m,t)){m.preventDefault();let _=i!==void 0?i:Rc(d)===Rc(g);f(s,{replace:_,state:o,preventScrollReset:a,relative:c,viewTransition:u})}},[d,f,g,i,o,t,s,a,c,u])}const Dy=({onComplete:s})=>{const[e,t]=Ie.useState(""),i="<BioElectro>";return Ie.useEffect(()=>{let o=0;const a=setInterval(()=>{t(i.substring(0,o)),o++,o>i.length&&(clearInterval(a),setTimeout(()=>{s()},1e3))},100);return()=>clearInterval(a)},[s]),_e.jsxs("div",{className:"fixed inset-0 z-50 bg-black text-gray-100 flex flex-col items-center justify-center",children:[_e.jsxs("div",{className:"mb-4 text-4xl font-mono font-bold",children:[e," ",_e.jsx("span",{className:"animate-blink ml-1",children:" | "})]}),_e.jsx("div",{className:"w-[200px] h-[2px] bg-gray-800 rounded relative overflow-hidden",children:_e.jsx("div",{className:"w-[40%] h-full bg-blue-500 shadow-[0_0_15px_#3b82f6] animate-loading-bar"})})]})},Iy=({menuOpen:s,setMenuOpen:e})=>(Ie.useEffect(()=>{document.body.style.overflow=s?"hidden":""},[s]),_e.jsx("nav",{className:"fixed top-0 w-full z-40 bg-[rgba(10, 10, 10, 0.8)] backdrop-blur-lg border-b border-white/10 shadow-lg",children:_e.jsx("div",{className:"max-w-5xl mx-auto px-4",children:_e.jsxs("div",{className:"flex justify-between items-center h-16",children:[_e.jsxs(xc,{to:"/",className:"font-mono text-xl font-bold text-white",children:["BioEchem",_e.jsx("span",{className:"text-emerlad-300",children:"Builds"})]}),_e.jsx("div",{className:"w-7 h-5 relative cursor-pointer z-40 md:hidden",onClick:()=>e(t=>!t),children:"☰"}),_e.jsxs("div",{className:"hidden md:flex items-center space-x-8",children:[_e.jsx(xc,{to:"/",className:"text-gray-300 hover:text-white transition-colors",children:"Home"}),_e.jsx("a",{href:"#about",className:"text-gray-300 hover:text-white transition-colors",children:"Usage"}),_e.jsx("a",{href:"#projects",className:"text-gray-300 hover:text-white transition-colors",children:"Part List"}),_e.jsx(xc,{to:"/contact",className:"text-gray-300 hover:text-white transition-colors",children:"Model"})]})]})})})),Ny=({menuOpen:s,setMenuOpen:e})=>_e.jsxs("div",{className:`fixed top-0 left-0 w-full bg-[rgba(10,10,10,0.8)] z-40 flex flex-col items-center justify-center
        transition-all duration-300 ease-in-out
        ${s?"h-screen opacity-100 pointer-events-auto":"h-0 opacity-0 pointer-events-none"}
      `,children:[_e.jsx("button",{onClick:()=>e(!1),className:"absolute top-6 right-6 text-white text-3xl focus:outline-none cursor-pointer","aria-label":"Close Menu",children:"×"}),_e.jsx("a",{href:"#home",onClick:()=>e(!1),className:`text-2xl font-semibold text-white my-4 transform transition-transform duration-300
          ${s?"opacity-100 translate-y-0":"opacity-0 translate-y-5"}`,children:"Home"}),_e.jsx("a",{href:"#about",onClick:()=>e(!1),className:`text-2xl font-semibold text-white my-4 transform transition-transform duration-300
          ${s?"opacity-100 translate-y-0":"opacity-0 translate-y-5"}`,children:"Usage"}),_e.jsx("a",{href:"#projects",onClick:()=>e(!1),className:`text-2xl font-semibold text-white my-4 transform transition-transform duration-300
          ${s?"opacity-100 translate-y-0":"opacity-0 translate-y-5"}`,children:"Part List"}),_e.jsx(xc,{to:"/contact",onClick:()=>e(!1),className:`text-2xl font-semibold text-white my-4 transform transition-transform duration-300
          ${s?"opacity-100 translate-y-0":"opacity-0 translate-y-5"}`,children:"Model"})]}),rd=({children:s})=>{const e=Ie.useRef(null);return Ie.useEffect(()=>{const t=new IntersectionObserver(([i])=>{i.isIntersecting&&e.current.classList.add("visible")},{threshold:.2,rootMargin:"0px 0px -50px 0px"});return e.current&&t.observe(e.current),()=>t.disconnect()}),_e.jsx("div",{ref:e,className:"reveal",children:s})},Uy=()=>_e.jsx("section",{id:"home",className:"min-h-screen flex items-center justify-center relative",children:_e.jsx(rd,{children:_e.jsxs("div",{className:"text-center z-10 px-4",children:[_e.jsx("h1",{className:"text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-emerald-600 to-emerald-400 bg-clip-text text-transparent leading-right",children:"Microbial Electrochemical Bioreactor"}),_e.jsx("p",{className:"tex-gray-400 text-lg mb-8 max-w-lg mx-auto",children:"3D printable electrochemical bioreactor for lab-scale microbial electrochemistry."}),_e.jsxs("div",{className:"flex justify-center space-x-4",children:[_e.jsx("a",{href:"#CAD Files",className:"bg-emerald-700 text-white py-3 px-6 rounded font-medium transition relative overflow-hidden hover:-translate-y-0.5 hover:shadow-[0_0_15px_rgba(59, 130, 246, 0.4)]",children:"CAD Files"}),_e.jsx("a",{href:"#projects",className:`bg-emerald-300 text-white py-3 px-6 rounded font-medium transition-all duration-200 
             hover:-translate-y-0.5 hover:shadow-[0_0_15px_rgba(59, 130, 246, 0.2)] hover:bg-blue-500/10`,children:"Part List"})]})]})})}),Fy=()=>{const s=["NIH 3D Database Deposit","Journal of Chemical Education Paper"],e=["3D Printing","Gasket Fabrication","Assembly"];return _e.jsx("section",{id:"about",className:"min-h-screen flex items-center justify-center py-20",children:_e.jsx(rd,{children:_e.jsxs("div",{className:"max-w-3xl mx-auto px-4",children:[_e.jsxs("h2",{className:"text-3xl font-bold mb-8 bg-gradient-to-r from-blue-500 to-cyan-400 bg-clip-text text-transparent text-center",children:[" ","Usage"]}),_e.jsxs("div",{className:"rounded-xl p-8 border-white/10 border hover:-translate-y-1 transition-all",children:[_e.jsx("p",{className:"text-gray-300 mb-6",children:"For 100mL scale microbial electrochemical experiments."}),_e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-6",children:[_e.jsxs("div",{className:"rounded-xl p-6 hover:-translate-y-1 transition-all",children:[_e.jsx("h3",{className:"text-xl font-bold mb-4",children:" Resources"}),_e.jsx("div",{className:"flex flex-wrap gap-2",children:s.map((t,i)=>_e.jsx("span",{className:`bg-blue-500/10 text-blue-500 py-1 px-3 rounded-full text-sm hover:bg-blue-500/20 
                                    hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition
                    `,children:t},i))})]}),_e.jsxs("div",{className:"rounded-xl p-6 hover:-translate-y-1 transition-all",children:[_e.jsx("h3",{className:"text-xl font-bold mb-4",children:" Protocols"}),_e.jsx("div",{className:"flex flex-wrap gap-2",children:e.map((t,i)=>_e.jsx("span",{className:`bg-blue-500/10 text-blue-500 py-1 px-3 rounded-full text-sm hover:bg-blue-500/20 
                                    hover:shadow-[0_2px_8px_rgba(59,130,2246,0.2)] transition
                    `,children:t},i))})]})]})]}),_e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-6 mt-8",children:[_e.jsxs("div",{className:"p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all",children:[_e.jsx("h3",{className:"text-xl font-bold mb-4",children:" 🏫 MIT Furst Lab "}),_e.jsxs("ul",{className:"list-disc list-inside text-gray-300 space-y-2",children:[_e.jsxs("li",{children:[_e.jsx("strong",{children:" Department of Chemical Engineering "})," - MIT 2025"]}),_e.jsx("li",{children:"Designed by: Swathi Penumutchu"})]})]}),_e.jsxs("div",{className:"p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all",children:[_e.jsx("h3",{className:"text-xl font-bold mb-4",children:" Cite "}),_e.jsxs("div",{className:"space-y-4 text-gray-300",children:[_e.jsxs("div",{children:[_e.jsxs("h4",{className:"font-semibold",children:[" ","GitHub Repo"," "]}),_e.jsx("p",{children:"Link to design files and WebApp."})]}),_e.jsxs("div",{children:[_e.jsxs("h4",{className:"font-semibold",children:[" ","BioEchemBuilds Database"," "]}),_e.jsx("p",{children:"Fabrication database with all builds in microbial elechemistry toolkit."})]})]})]})]})]})})})},Oy=()=>_e.jsx("section",{id:"projects",className:"min-h-screen flex items-center justify-center py-20",children:_e.jsx(rd,{children:_e.jsxs("div",{className:"max-w-5xl mx-auto px-4",children:[_e.jsxs("h2",{className:"text-3xl font-bold mb-8 bg-gradient-to-r from-blue-500 to-cyan-400 bg-clip-text text-transparent text-center",children:[" ","Part List"]}),_e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-6",children:[_e.jsxs("div",{className:"p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition",children:[_e.jsx("h3",{className:"text-xl font-bold mb-2",children:" Links"}),_e.jsx("p",{className:"text-gray-400 mb-4",children:"Additional Required Parts."}),_e.jsx("div",{className:"flex flex-wrap gap-2 mb-4",children:["Glass Jar","Gasket 1","Gasket 2"].map((s,e)=>_e.jsx("span",{className:`bg-blue-500/10 text-blue-500 py-1 px-3 rounded-full text-sm hover:bg-blue-500/20 
                                    hover:shadow-[0_2px_8px_rgba(59,130,246,0.1)] transition-all
                    `,children:s},e))}),_e.jsx("div",{className:"flex justify-between items-center",children:_e.jsx("a",{href:"#",className:"text-blue-400 hover:text-blue-300 transition-colors my-4",children:"McMaster →"})})]}),_e.jsxs("div",{className:`
              glass p-6 rounded-xl border border-white/10 
              hover:-translate-y-1 hover:border-blue-500/30
              hover:shadow-[0_4px_20px_rgba(59,130,246,0.1)]
              transition-all
            `,children:[_e.jsx("h3",{className:"text-xl font-bold mb-2",children:"Electrodes"}),_e.jsx("p",{className:"text-gray-400 mb-4",children:"Materials for Working Counter and Reference Electrodes."}),_e.jsx("div",{className:"flex flex-wrap gap-2 mb-4",children:["Fuel Cell Store","WPI","CHI"].map((s,e)=>_e.jsx("span",{className:`
                      bg-blue-500/10 text-blue-500 py-1 px-3 
                      rounded-full text-sm
                      transition
                      hover:bg-blue-500/20 hover:-translate-y-0.5
                      hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)]
                    `,children:s},e))}),_e.jsx("div",{className:"flex justify-between items-center ",children:_e.jsx("a",{href:"#",className:"text-blue-400 hover:text-blue-300 transition-colors my-4",children:"Purchase →"})})]})]})]})})});/**
 * @license
