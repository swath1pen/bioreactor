 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Zm;function yx(){if(Zm)return ca;Zm=1;var s=nd(),e=Symbol.for("react.element"),t=Symbol.for("react.fragment"),i=Object.prototype.hasOwnProperty,o=s.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,a={key:!0,ref:!0,__self:!0,__source:!0};function c(u,f,d){var g,p={},_=null,y=null;d!==void 0&&(_=""+d),f.key!==void 0&&(_=""+f.key),f.ref!==void 0&&(y=f.ref);for(g in f)i.call(f,g)&&!a.hasOwnProperty(g)&&(p[g]=f[g]);if(u&&u.defaultProps)for(g in f=u.defaultProps,f)p[g]===void 0&&(p[g]=f[g]);return{$$typeof:e,type:u,key:_,ref:y,props:p,_owner:o.current}}return ca.Fragment=t,ca.jsx=c,ca.jsxs=c,ca}var Jm;function Sx(){return Jm||(Jm=1,gh.exports=yx()),gh.exports}var ge=Sx(),Ie=nd();const k_=O_(Ie),Ex=vx({__proto__:null,default:k_},[Ie]);var Wl={},vh={exports:{}},Vn={},xh={exports:{}},yh={};/**
 * @license React
 ...
 *
 * @license MIT
 */function Ta(){return Ta=Object.assign?Object.assign.bind():function(s){for(var e=1;e<arguments.length;e++){var t=arguments[e];for(var i in t)Object.prototype.hasOwnProperty.call(t,i)&&(s[i]=t[i])}return s},Ta.apply(this,arguments)}var kr;(function(s){s.Pop="POP",s.Push="PUSH",s.Replace="REPLACE"})(kr||(kr={}));const rg="popstate";function Cx(s){s===void 0&&(s={});function e(i,o){let{pathname:a,search:c,hash:u}=i.location;return lf("",{pathname:a,search:c,hash:u},o.state&&o.state.usr||null,o.state&&o.state.key||"default")}function t(i,o){return typeof o=="string"?o:Rc(o)}return Lx(e,t,null,s)}function nn(s,e){if(s===!1||s===null||typeof s>"u")throw new Error(e)}function z_(s,e){if(!s){typeof console<"u"&&console.warn(e);try{throw new Error(e)}catch{}}}function Px(){return Math.random().toString(36).substr(2,8)}function sg(s,e){return{usr:s.state,key:s.key,idx:e}}function lf(s,e,t,i){return t===void 0&&(t=null),Ta({pathname:typeof s=="string"?s:s.pathname,search:"",hash:""},typeof e=="string"?Ao(e):e,{state:t,key:e&&e.key||i||Px()})}function Rc(s){let{pathname:e="/",search:t="",hash:i=""}=s;return t&&t!=="?"&&(e+=t.charAt(0)==="?"?t:"?"+t),i&&i!=="#"&&(e+=i.charAt(0)==="#"?i:"#"+i),e}function Ao(s){let e={};if(s){let t=s.indexOf("#");t>=0&&(e.hash=s.substr(t),s=s.substr(0,t));let i=s.indexOf("?");i>=0&&(e.search=s.substr(i),s=s.substr(0,i)),s&&(e.pathname=s)}return e}function Lx(s,e,t,i){i===void 0&&(i={});let{window:o=document.defaultView,v5Compat:a=!1}=i,c=o.history,u=kr.Pop,f=null,d=g();d==null&&(d=0,c.replaceState(Ta({},c.state,{idx:d}),""));function g(){return(c.state||{idx:null}).idx}function p(){u=kr.Pop;let S=g(),x=S==null?null:S-d;d=S,f&&f({action:u,location:M.location,delta:x})}function _(S,x){u=kr.Push;let D=lf(M.location,S,x);d=g()+1;let P=sg(D,d),R=M.createHref(D);try{c.pushState(P,"",R)}catch(U){if(U instanceof DOMException&&U.name==="DataCloneError")throw U;o.location.assign(R)}a&&f&&f({action:u,location:M.location,delta:1})}function y(S,x){u=kr.Replace;let D=lf(M.location,S,x);d=g();let P=sg(D,d),R=M.createHref(D);c.replaceState(P,"",R),a&&f&&f({action:u,location:M.location,delta:0})}function E(S){let x=o.location.origin!=="null"?o.location.origin:o.location.href,D=typeof S=="string"?S:Rc(S);return D=D.replace(/ $/,"%20"),nn(x,"No window.location.(origin|href) available to create URL for href: "+D),new URL(D,x)}let M={get action(){return u},get location(){return s(o,c)},listen(S){if(f)throw new Error("A history only accepts one active listener");return o.addEventListener(rg,p),f=S,()=>{o.removeEventListener(rg,p),f=null}},createHref(S){return e(o,S)},createURL:E,encodeLocation(S){let x=E(S);return{pathname:x.pathname,search:x.search,hash:x.hash}},push:_,replace:y,go(S){return c.go(S)}};return M}var og;(function(s){s.data="data",s.deferred="deferred",s.redirect="redirect",s.error="error"})(og||(og={}));function Dx(s,e,t){return t===void 0&&(t="/"),Ix(s,e,t)}function Ix(s,e,t,i){let o=typeof e=="string"?Ao(e):e,a=id(o.pathname||"/",t);if(a==null)return null;let c=H_(s);Nx(c);let u=null;for(let f=0;u==null&&f<c.length;++f){let d=jx(a);u=Gx(c[f],d)}return u}function H_(s,e,t,i){e===void 0&&(e=[]),t===void 0&&(t=[]),i===void 0&&(i="");let o=(a,c,u)=>{let f={relativePath:u===void 0?a.path||"":u,caseSensitive:a.caseSensitive===!0,childrenIndex:c,route:a};f.relativePath.startsWith("/")&&(nn(f.relativePath.startsWith(i),'Absolute route path "'+f.relativePath+'" nested under path '+('"'+i+'" is not valid. An absolute child route path ')+"must start with the combined path of all its parent routes."),f.relativePath=f.relativePath.slice(i.length));let d=zr([i,f.relativePath]),g=t.concat(f);a.children&&a.children.length>0&&(nn(a.index!==!0,"Index routes must not have child routes. Please remove "+('all child routes from route path "'+d+'".')),H_(a.children,e,g,d)),!(a.path==null&&!a.index)&&e.push({path:d,score:Hx(d,a.index),routesMeta:g})};return s.forEach((a,c)=>{var u;if(a.path===""||!((u=a.path)!=null&&u.includes("?")))o(a,c);else for(let f of V_(a.path))o(a,c,f)}),e}function V_(s){let e=s.split("/");if(e.length===0)return[];let[t,...i]=e,o=t.endsWith("?"),a=t.replace(/\?$/,"");if(i.length===0)return o?[a,""]:[a];let c=V_(i.join("/")),u=[];return u.push(...c.map(f=>f===""?a:[a,f].join("/"))),o&&u.push(...c),u.map(f=>s.startsWith("/")&&f===""?"/":f)}function Nx(s){s.sort((e,t)=>e.score!==t.score?t.score-e.score:Vx(e.routesMeta.map(i=>i.childrenIndex),t.routesMeta.map(i=>i.childrenIndex)))}const Ux=/^:[\w-]+$/,Fx=3,Ox=2,kx=1,Bx=10,zx=-2,ag=s=>s==="*";function Hx(s,e){let t=s.split("/"),i=t.length;return t.some(ag)&&(i+=zx),e&&(i+=Ox),t.filter(o=>!ag(o)).reduce((o,a)=>o+(Ux.test(a)?Fx:a===""?kx:Bx),i)}function Vx(s,e){return s.length===e.length&&s.slice(0,-1).every((i,o)=>i===e[o])?s[s.length-1]-e[e.length-1]:0}function Gx(s,e,t){let{routesMeta:i}=s,o={},a="/",c=[];for(let u=0;u<i.length;++u){let f=i[u],d=u===i.length-1,g=a==="/"?e:e.slice(a.length)||"/",p=Wx({path:f.relativePath,caseSensitive:f.caseSensitive,end:d},g),_=f.route;if(!p)return null;Object.assign(o,p.params),c.push({params:o,pathname:zr([a,p.pathname]),pathnameBase:$x(zr([a,p.pathnameBase])),route:_}),p.pathnameBase!=="/"&&(a=zr([a,p.pathnameBase]))}return c}function Wx(s,e){typeof s=="string"&&(s={path:s,caseSensitive:!1,end:!0});let[t,i]=Xx(s.path,s.caseSensitive,s.end),o=e.match(t);if(!o)return null;let a=o[0],c=a.replace(/(.)\/+$/,"$1"),u=o.slice(1);return{params:i.reduce((d,g,p)=>{let{paramName:_,isOptional:y}=g;if(_==="*"){let M=u[p]||"";c=a.slice(0,a.length-M.length).replace(/(.)\/+$/,"$1")}const E=u[p];return y&&!E?d[_]=void 0:d[_]=(E||"").replace(/%2F/g,"/"),d},{}),pathname:a,pathnameBase:c,pattern:s}}function Xx(s,e,t){e===void 0&&(e=!1),t===void 0&&(t=!0),z_(s==="*"||!s.endsWith("*")||s.endsWith("/*"),'Route path "'+s+'" will be treated as if it were '+('"'+s.replace(/\*$/,"/*")+'" because the `*` character must ')+"always follow a `/` in the pattern. To get rid of this warning, "+('please change the route path to "'+s.replace(/\*$/,"/*")+'".'));let i=[],o="^"+s.replace(/\/*\*?$/,"").replace(/^\/*/,"/").replace(/[\\.*+^${}|()[\]]/g,"\\$&").replace(/\/:([\w-]+)(\?)?/g,(c,u,f)=>(i.push({paramName:u,isOptional:f!=null}),f?"/?([^\\/]+)?":"/([^\\/]+)"));return s.endsWith("*")?(i.push({paramName:"*"}),o+=s==="*"||s==="/*"?"(.*)$":"(?:\\/(.+)|\\/*)$"):t?o+="\\/*$":s!==""&&s!=="/"&&(o+="(?:(?=\\/|$))"),[new RegExp(o,e?void 0:"i"),i]}function jx(s){try{return s.split("/").map(e=>decodeURIComponent(e).replace(/\//g,"%2F")).join("/")}catch(e){return z_(!1,'The URL path "'+s+'" could not be decoded because it is is a malformed URL segment. This is probably due to a bad percent '+("encoding ("+e+").")),s}}function id(s,e){if(e==="/")return s;if(!s.toLowerCase().startsWith(e.toLowerCase()))return null;let t=e.endsWith("/")?e.length-1:e.length,i=s.charAt(t);return i&&i!=="/"?null:s.slice(t)||"/"}function Yx(s,e){e===void 0&&(e="/");let{pathname:t,search:i="",hash:o=""}=typeof s=="string"?Ao(s):s;return{pathname:t?t.startsWith("/")?t:Kx(t,e):e,search:Zx(i),hash:Jx(o)}}function Kx(s,e){let t=e.replace(/\/+$/,"").split("/");return s.split("/").forEach(o=>{o===".."?t.length>1&&t.pop():o!=="."&&t.push(o)}),t.length>1?t.join("/"):"/"}function Sh(s,e,t,i){return"Cannot include a '"+s+"' character in a manually specified "+("`to."+e+"` field ["+JSON.stringify(i)+"].  Please separate it out to the ")+("`to."+t+"` field. Alternatively you may provide the full path as ")+'a string in <Link to="..."> and the router will parse it for you.'}function qx(s){return s.filter((e,t)=>t===0||e.route.path&&e.route.path.length>0)}function G_(s,e){let t=qx(s);return e?t.map((i,o)=>o===t.length-1?i.pathname:i.pathnameBase):t.map(i=>i.pathnameBase)}function W_(s,e,t,i){i===void 0&&(i=!1);let o;typeof s=="string"?o=Ao(s):(o=Ta({},s),nn(!o.pathname||!o.pathname.includes("?"),Sh("?","pathname","search",o)),nn(!o.pathname||!o.pathname.includes("#"),Sh("#","pathname","hash",o)),nn(!o.search||!o.search.includes("#"),Sh("#","search","hash",o)));let a=s===""||o.pathname==="",c=a?"/":o.pathname,u;if(c==null)u=t;else{let p=e.length-1;if(!i&&c.startsWith("..")){let _=c.split("/");for(;_[0]==="..";)_.shift(),p-=1;o.pathname=_.join("/")}u=p>=0?e[p]:"/"}let f=Yx(o,u),d=c&&c!=="/"&&c.endsWith("/"),g=(a||c===".")&&t.endsWith("/");return!f.pathname.endsWith("/")&&(d||g)&&(f.pathname+="/"),f}const zr=s=>s.join("/").replace(/\/\/+/g,"/"),$x=s=>s.replace(/\/+$/,"").replace(/^\/*/,"/"),Zx=s=>!s||s==="?"?"":s.startsWith("?")?s:"?"+s,Jx=s=>!s||s==="#"?"":s.startsWith("#")?s:"#"+s;function Qx(s){return s!=null&&typeof s.status=="number"&&typeof s.statusText=="string"&&typeof s.internal=="boolean"&&"data"in s}const X_=["post","put","patch","delete"];new Set(X_);const ey=["get",...X_];new Set(ey);/**
 ...
 *
 * @license MIT
 */function hf(){return hf=Object.assign?Object.assign.bind():function(s){for(var e=1;e<arguments.length;e++){var t=arguments[e];for(var i in t)Object.prototype.hasOwnProperty.call(t,i)&&(s[i]=t[i])}return s},hf.apply(this,arguments)}function Sy(s,e){if(s==null)return{};var t={},i=Object.keys(s),o,a;for(a=0;a<i.length;a++)o=i[a],!(e.indexOf(o)>=0)&&(t[o]=s[o]);return t}function Ey(s){return!!(s.metaKey||s.altKey||s.ctrlKey||s.shiftKey)}function My(s,e){return s.button===0&&(!e||e==="_self")&&!Ey(s)}const Ty=["onClick","relative","reloadDocument","replace","state","target","to","preventScrollReset","viewTransition"],wy="6";try{window.__reactRouterVersion=wy}catch{}const Ay="startTransition",cg=Ex[Ay];function Ry(s){let{basename:e,children:t,future:i,window:o}=s,a=Ie.useRef();a.current==null&&(a.current=Cx({window:o,v5Compat:!0}));let c=a.current,[u,f]=Ie.useState({action:c.action,location:c.location}),{v7_startTransition:d}=i||{},g=Ie.useCallback(p=>{d&&cg?cg(()=>f(p)):f(p)},[f,d]);return Ie.useLayoutEffect(()=>c.listen(g),[c,g]),Ie.useEffect(()=>vy(i),[i]),Ie.createElement(xy,{basename:e,children:t,location:u.location,navigationType:u.action,navigator:c,future:i})}const by=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u",Cy=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,xc=Ie.forwardRef(function(e,t){let{onClick:i,relative:o,reloadDocument:a,replace:c,state:u,target:f,to:d,preventScrollReset:g,viewTransition:p}=e,_=Sy(e,Ty),{basename:y}=Ie.useContext(xs),E,M=!1;if(typeof d=="string"&&Cy.test(d)&&(E=d,by))try{let P=new URL(window.location.href),R=d.startsWith("//")?new URL(P.protocol+d):new URL(d),U=id(R.pathname,y);R.origin===P.origin&&U!=null?d=U+R.search+R.hash:M=!0}catch{}let S=ny(d,{relative:o}),x=Py(d,{replace:c,state:u,target:f,preventScrollReset:g,relative:o,viewTransition:p});function D(P){i&&i(P),P.defaultPrevented||x(P)}return Ie.createElement("a",hf({},_,{href:E||S,onClick:M||a?i:D,ref:t,target:f}))});var ug;(function(s){s.UseScrollRestoration="useScrollRestoration",s.UseSubmit="useSubmit",s.UseSubmitFetcher="useSubmitFetcher",s.UseFetcher="useFetcher",s.useViewTransitionState="useViewTransitionState"})(ug||(ug={}));var hg;(function(s){s.UseFetcher="useFetcher",s.UseFetchers="useFetchers",s.UseScrollRestoration="useScrollRestoration"})(hg||(hg={}));function Py(s,e){let{target:t,replace:i,state:o,preventScrollReset:a,relative:c,viewTransition:u}=e===void 0?{}:e,f=iy(),d=Nc(),g=K_(s,{relative:c});return Ie.useCallback(p=>{if(My(p,t)){p.preventDefault();let _=i!==void 0?i:Rc(d)===Rc(g);f(s,{replace:_,state:o,preventScrollReset:a,relative:c,viewTransition:u})}},[d,f,g,i,o,t,s,a,c,u])}const Ly=({onComplete:s})=>{const[e,t]=Ie.useState(""),i="<BioElectro>";return Ie.useEffect(()=>{let o=0;const a=setInterval(()=>{t(i.substring(0,o)),o++,o>i.length&&(clearInterval(a),setTimeout(()=>{s()},1e3))},100);return()=>clearInterval(a)},[s]),ge.jsxs("div",{className:"fixed inset-0 z-50 bg-black text-gray-100 flex flex-col items-center justify-center",children:[ge.jsxs("div",{className:"mb-4 text-4xl font-mono font-bold",children:[e," ",ge.jsx("span",{className:"animate-blink ml-1",children:" | "})]}),ge.jsx("div",{className:"w-[200px] h-[2px] bg-gray-800 rounded relative overflow-hidden",children:ge.jsx("div",{className:"w-[40%] h-full bg-blue-500 shadow-[0_0_15px_#3b82f6] animate-loading-bar"})})]})},Dy=({menuOpen:s,setMenuOpen:e})=>(Ie.useEffect(()=>{document.body.style.overflow=s?"hidden":""},[s]),ge.jsx("nav",{className:"fixed top-0 w-full z-40 bg-[rgba(10, 10, 10, 0.8)] backdrop-blur-lg border-b border-white/10 shadow-lg",children:ge.jsx("div",{className:"max-w-5xl mx-auto px-4",children:ge.jsxs("div",{className:"flex justify-between items-center h-16",children:[ge.jsxs(xc,{to:"/",className:"font-mono text-xl font-bold text-white",children:["BioEchem",ge.jsx("span",{className:"text-emerlad-300",children:"Builds"})]}),ge.jsx("div",{className:"w-7 h-5 relative cursor-pointer z-40 md:hidden",onClick:()=>e(t=>!t),children:"☰"}),ge.jsxs("div",{className:"hidden md:flex items-center space-x-8",children:[ge.jsx(xc,{to:"/",className:"text-gray-300 hover:text-white transition-colors",children:"Home"}),ge.jsx("a",{href:"#about",className:"text-gray-300 hover:text-white transition-colors",children:"Usage"}),ge.jsx("a",{href:"#projects",className:"text-gray-300 hover:text-white transition-colors",children:"Part List"}),ge.jsx(xc,{to:"/contact",className:"text-gray-300 hover:text-white transition-colors",children:"Model"})]})]})})})),Iy=({menuOpen:s,setMenuOpen:e})=>ge.jsxs("div",{className:`fixed top-0 left-0 w-full bg-[rgba(10,10,10,0.8)] z-40 flex flex-col items-center justify-center
...
void main() {
	...
	`}function Jw(s){let e=new WeakMap,t=null;function i(u){if(u&&u.isTexture){const f=u.mapping,d=f===Sf||f===Ef,g=f===vo||f===xo;if(d||g){let p=e.get(u);const _=p!==void 0?p.texture.pmremVersion:0;if(u.isRenderTargetTexture&&u.pmremVersion!==_)return t===null&&(t=new c_(s)),p=d?t.fromEquirectangular(u,p):t.fromCubemap(u,p),p.texture.pmremVersion=u.pmremVersion,e.set(u,p),p.texture;if(p!==void 0)return p.texture;{const y=u.image;return d&&y&&y.height>0||g&&y&&o(y)?(t===null&&(t=new c_(s)),p=d?t.fromEquirectangular(u):t.fromCubemap(u),p.texture.pmremVersion=u.pmremVersion,e.set(u,p),u.addEventListener("dispose",a),p.texture):null}}}return u}function o(u){let f=0;const d=6;for(let g=0;g<d;g++)u[g]!==void 0&&f++;return f===d}function a(u){const f=u.target;f.removeEventListener("dispose",a);const d=e.get(f);d!==void 0&&(e.delete(f),d.dispose())}function c(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:i,dispose:c}}function Qw(s){const e={};function t(i){if(e[i]!==void 0)return e[i];let o;switch(i){case"WEBGL_depth_texture":o=s.getExtension("WEBGL_depth_texture")||s.getExtension("MOZ_WEBGL_depth_texture")||s.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":o=s.getExtension("EXT_texture_filter_anisotropic")||s.getExtension("MOZ_EXT_texture_filter_anisotropic")||s.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":o=s.getExtension("WEBGL_compressed_texture_s3tc")||s.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||s.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":o=s.getExtension("WEBGL_compressed_texture_pvrtc")||s.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:o=s.getExtension(i)}return e[i]=o,o}return{has:function(i){return t(i)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(i){const o=t(i);return o===null&&po("THREE.WebGLRenderer: "+i+" extension not supported."),o}}}function eA(s,e,t,i){const o={},a=new WeakMap;function c(p){const _=p.target;_.index!==null&&e.remove(_.index);for(const E in _.attributes)e.remove(_.attributes[E]);_.removeEventListener("dispose",c),delete o[_.id];const y=a.get(_);y&&(e.remove(y),a.delete(_)),i.releaseStatesOfGeometry(_),_.isInstancedBufferGeometry===!0&&delete _._maxInstanceCount,t.memory.geometries--}function u(p,_){return o[_.id]===!0||(_.addEventListener("dispose",c),o[_.id]=!0,t.memory.geometries++),_}function f(p){const _=p.attributes;for(const y in _)e.update(_[y],s.ARRAY_BUFFER)}function d(p){const _=[],y=p.index,E=p.attributes.position;let M=0;if(y!==null){const D=y.array;M=y.version;for(let P=0,R=D.length;P<R;P+=3){const U=D[P+0],z=D[P+1],O=D[P+2];_.push(U,z,z,O,O,U)}}else if(E!==void 0){const D=E.array;M=E.version;for(let P=0,R=D.length/3-1;P<R;P+=3){const U=P+0,z=P+1,O=P+2;_.push(U,z,z,O,O,U)}}else return;const S=new(dv(_)?vv:_v)(_,1);S.version=M;const x=a.get(p);x&&e.remove(x),a.set(p,S)}function g(p){const _=a.get(p);if(_){const y=p.index;y!==null&&_.version<y.version&&d(p)}else d(p);return a.get(p)}return{get:u,update:f,getWireframeAttribute:g}}function tA(s,e,t){let i;function o(_){i=_}let a,c;function u(_){a=_.type,c=_.bytesPerElement}function f(_,y){s.drawElements(i,y,a,_*c),t.update(y,i,1)}function d(_,y,E){E!==0&&(s.drawElementsInstanced(i,y,a,_*c,E),t.update(y,i,E))}function g(_,y,E){if(E===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(i,y,0,a,_,0,E);let S=0;for(let x=0;x<E;x++)S+=y[x];t.update(S,i,1)}function p(_,y,E,M){if(E===0)return;const S=e.get("WEBGL_multi_draw");if(S===null)for(let x=0;x<_.length;x++)d(_[x]/c,y[x],M[x]);else{S.multiDrawElementsInstancedWEBGL(i,y,0,a,_,0,M,0,E);let x=0;for(let D=0;D<E;D++)x+=y[D]*M[D];t.update(x,i,1)}}this.setMode=o,this.setIndex=u,this.render=f,this.renderInstances=d,this.renderMultiDraw=g,this.renderMultiDrawInstances=p}function nA(s){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function i(a,c,u){switch(t.calls++,c){case s.TRIANGLES:t.triangles+=u*(a/3);break;case s.LINES:t.lines+=u*(a/2);break;case s.LINE_STRIP:t.lines+=u*(a-1);break;case s.LINE_LOOP:t.lines+=u*a;break;case s.POINTS:t.points+=u*a;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",c);break}}function o(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:o,update:i}}function iA(s,e,t){const i=new WeakMap,o=new bt;function a(c,u,f){const d=c.morphTargetInfluences,g=u.morphAttributes.position||u.morphAttributes.normal||u.morphAttributes.color,p=g!==void 0?g.length:0;let _=i.get(u);if(_===void 0||_.count!==p){let b=function(){Y.dispose(),i.delete(u),u.removeEventListener("dispose",b)};var y=b;_!==void 0&&_.texture.dispose();const E=u.morphAttributes.position!==void 0,M=u.morphAttributes.normal!==void 0,S=u.morphAttributes.color!==void 0,x=u.morphAttributes.position||[],D=u.morphAttributes.normal||[],P=u.morphAttributes.color||[];let R=0;E===!0&&(R=1),M===!0&&(R=2),S===!0&&(R=3);let U=u.attributes.position.count*R,z=1;U>e.maxTextureSize&&(z=Math.ceil(U/e.maxTextureSize),U=e.maxTextureSize);const O=new Float32Array(U*z*4*p),Y=new pv(O,U,z,p);Y.type=Ei,Y.needsUpdate=!0;const C=R*4;for(let F=0;F<p;F++){const le=x[F],ne=D[F],ae=P[F],he=U*z*4*F;for(let se=0;se<le.count;se++){const ue=se*C;E===!0&&(o.fromBufferAttribute(le,se),O[he+ue+0]=o.x,O[he+ue+1]=o.y,O[he+ue+2]=o.z,O[he+ue+3]=0),M===!0&&(o.fromBufferAttribute(ne,se),O[he+ue+4]=o.x,O[he+ue+5]=o.y,O[he+ue+6]=o.z,O[he+ue+7]=0),S===!0&&(o.fromBufferAttribute(ae,se),O[he+ue+8]=o.x,O[he+ue+9]=o.y,O[he+ue+10]=o.z,O[he+ue+11]=ae.itemSize===4?o.w:1)}}_={count:p,texture:Y,size:new ct(U,z)},i.set(u,_),u.addEventListener("dispose",b)}if(c.isInstancedMesh===!0&&c.morphTexture!==null)f.getUniforms().setValue(s,"morphTexture",c.morphTexture,t);else{let E=0;for(let S=0;S<d.length;S++)E+=d[S];const M=u.morphTargetsRelative?1:1-E;f.getUniforms().setValue(s,"morphTargetBaseInfluence",M),f.getUniforms().setValue(s,"morphTargetInfluences",d)}f.getUniforms().setValue(s,"morphTargetsTexture",_.texture,t),f.getUniforms().setValue(s,"morphTargetsTextureSize",_.size)}return{update:a}}function rA(s,e,t,i){let o=new WeakMap;function a(f){const d=i.render.frame,g=f.geometry,p=e.get(f,g);if(o.get(p)!==d&&(e.update(p),o.set(p,d)),f.isInstancedMesh&&(f.hasEventListener("dispose",u)===!1&&f.addEventListener("dispose",u),o.get(f)!==d&&(t.update(f.instanceMatrix,s.ARRAY_BUFFER),f.instanceColor!==null&&t.update(f.instanceColor,s.ARRAY_BUFFER),o.set(f,d))),f.isSkinnedMesh){const _=f.skeleton;o.get(_)!==d&&(_.update(),o.set(_,d))}return p}function c(){o=new WeakMap}function u(f){const d=f.target;d.removeEventListener("dispose",u),t.remove(d.instanceMatrix),d.instanceColor!==null&&t.remove(d.instanceColor)}return{update:a,dispose:c}}const Dv=new mn,d_=new Av(1,1),Iv=new pv,Nv=new qS,Uv=new Sv,p_=[],m_=[],g_=new Float32Array(16),__=new Float32Array(9),v_=new Float32Array(4);function Po(s,e,t){const i=s[0];if(i<=0||i>0)return s;const o=e*t;let a=p_[o];if(a===void 0&&(a=new Float32Array(o),p_[o]=a),e!==0){i.toArray(a,0);for(let c=1,u=0;c!==e;++c)u+=t,s[c].toArray(a,u)}return a}function ln(s,e){if(s.length!==e.length)return!1;for(let t=0,i=s.length;t<i;t++)if(s[t]!==e[t])return!1;return!0}function cn(s,e){for(let t=0,i=e.length;t<i;t++)s[t]=e[t]}function kc(s,e){let t=m_[e];t===void 0&&(t=new Int32Array(e),m_[e]=t);for(let i=0;i!==e;++i)t[i]=s.allocateTextureUnit();return t}function sA(s,e){const t=this.cache;t[0]!==e&&(s.uniform1f(this.addr,e),t[0]=e)}function oA(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(ln(t,e))return;s.uniform2fv(this.addr,e),cn(t,e)}}function aA(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(s.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(ln(t,e))return;s.uniform3fv(this.addr,e),cn(t,e)}}function lA(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(ln(t,e))return;s.uniform4fv(this.addr,e),cn(t,e)}}function cA(s,e){const t=this.cache,i=e.elements;if(i===void 0){if(ln(t,e))return;s.uniformMatrix2fv(this.addr,!1,e),cn(t,e)}else{if(ln(t,i))return;v_.set(i),s.uniformMatrix2fv(this.addr,!1,v_),cn(t,i)}}function uA(s,e){const t=this.cache,i=e.elements;if(i===void 0){if(ln(t,e))return;s.uniformMatrix3fv(this.addr,!1,e),cn(t,e)}else{if(ln(t,i))return;__.set(i),s.uniformMatrix3fv(this.addr,!1,__),cn(t,i)}}function hA(s,e){const t=this.cache,i=e.elements;if(i===void 0){if(ln(t,e))return;s.uniformMatrix4fv(this.addr,!1,e),cn(t,e)}else{if(ln(t,i))return;g_.set(i),s.uniformMatrix4fv(this.addr,!1,g_),cn(t,i)}}function fA(s,e){const t=this.cache;t[0]!==e&&(s.uniform1i(this.addr,e),t[0]=e)}function dA(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(ln(t,e))return;s.uniform2iv(this.addr,e),cn(t,e)}}function pA(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(ln(t,e))return;s.uniform3iv(this.addr,e),cn(t,e)}}function mA(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(ln(t,e))return;s.uniform4iv(this.addr,e),cn(t,e)}}function gA(s,e){const t=this.cache;t[0]!==e&&(s.uniform1ui(this.addr,e),t[0]=e)}function _A(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(ln(t,e))return;s.uniform2uiv(this.addr,e),cn(t,e)}}function vA(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(ln(t,e))return;s.uniform3uiv(this.addr,e),cn(t,e)}}function xA(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(ln(t,e))return;s.uniform4uiv(this.addr,e),cn(t,e)}}function yA(s,e,t){const i=this.cache,o=t.allocateTextureUnit();i[0]!==o&&(s.uniform1i(this.addr,o),i[0]=o);let a;this.type===s.SAMPLER_2D_SHADOW?(d_.compareFunction=hv,a=d_):a=Dv,t.setTexture2D(e||a,o)}function SA(s,e,t){const i=this.cache,o=t.allocateTextureUnit();i[0]!==o&&(s.uniform1i(this.addr,o),i[0]=o),t.setTexture3D(e||Nv,o)}function EA(s,e,t){const i=this.cache,o=t.allocateTextureUnit();i[0]!==o&&(s.uniform1i(this.addr,o),i[0]=o),t.setTextureCube(e||Uv,o)}function MA(s,e,t){const i=this.cache,o=t.allocateTextureUnit();i[0]!==o&&(s.uniform1i(this.addr,o),i[0]=o),t.setTexture2DArray(e||Iv,o)}function TA(s){switch(s){case 5126:return sA;case 35664:return oA;case 35665:return aA;case 35666:return lA;case 35674:return cA;case 35675:return uA;case 35676:return hA;case 5124:case 35670:return fA;case 35667:case 35671:return dA;case 35668:case 35672:return pA;case 35669:case 35673:return mA;case 5125:return gA;case 36294:return _A;case 36295:return vA;case 36296:return xA;case 35678:case 36198:case 36298:case 36306:case 35682:return yA;case 35679:case 36299:case 36307:return SA;case 35680:case 36300:case 36308:case 36293:return EA;case 36289:case 36303:case 36311:case 36292:return MA}}function wA(s,e){s.uniform1fv(this.addr,e)}function AA(s,e){const t=Po(e,this.size,2);s.uniform2fv(this.addr,t)}function RA(s,e){const t=Po(e,this.size,3);s.uniform3fv(this.addr,t)}function bA(s,e){const t=Po(e,this.size,4);s.uniform4fv(this.addr,t)}function CA(s,e){const t=Po(e,this.size,4);s.uniformMatrix2fv(this.addr,!1,t)}function PA(s,e){const t=Po(e,this.size,9);s.uniformMatrix3fv(this.addr,!1,t)}function LA(s,e){const t=Po(e,this.size,16);s.uniformMatrix4fv(this.addr,!1,t)}function DA(s,e){s.uniform1iv(this.addr,e)}function IA(s,e){s.uniform2iv(this.addr,e)}function NA(s,e){s.uniform3iv(this.addr,e)}function UA(s,e){s.uniform4iv(this.addr,e)}function FA(s,e){s.uniform1uiv(this.addr,e)}function OA(s,e){s.uniform2uiv(this.addr,e)}function kA(s,e){s.uniform3uiv(this.addr,e)}function BA(s,e){s.uniform4uiv(this.addr,e)}function zA(s,e,t){const i=this.cache,o=e.length,a=kc(t,o);ln(i,a)||(s.uniform1iv(this.addr,a),cn(i,a));for(let c=0;c!==o;++c)t.setTexture2D(e[c]||Dv,a[c])}function HA(s,e,t){const i=this.cache,o=e.length,a=kc(t,o);ln(i,a)||(s.uniform1iv(this.addr,a),cn(i,a));for(let c=0;c!==o;++c)t.setTexture3D(e[c]||Nv,a[c])}function VA(s,e,t){const i=this.cache,o=e.length,a=kc(t,o);ln(i,a)||(s.uniform1iv(this.addr,a),cn(i,a));for(let c=0;c!==o;++c)t.setTextureCube(e[c]||Uv,a[c])}function GA(s,e,t){const i=this.cache,o=e.length,a=kc(t,o);ln(i,a)||(s.uniform1iv(this.addr,a),cn(i,a));for(let c=0;c!==o;++c)t.setTexture2DArray(e[c]||Iv,a[c])}function WA(s){switch(s){case 5126:return wA;case 35664:return AA;case 35665:return RA;case 35666:return bA;case 35674:return CA;case 35675:return PA;case 35676:return LA;case 5124:case 35670:return DA;case 35667:case 35671:return IA;case 35668:case 35672:return NA;case 35669:case 35673:return UA;case 5125:return FA;case 36294:return OA;case 36295:return kA;case 36296:return BA;case 35678:case 36198:case 36298:case 36306:case 35682:return zA;case 35679:case 36299:case 36307:return HA;case 35680:case 36300:case 36308:case 36293:return VA;case 36289:case 36303:case 36311:case 36292:return GA}}class XA{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.setValue=TA(t.type)}}class jA{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=WA(t.type)}}class YA{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,i){const o=this.seq;for(let a=0,c=o.length;a!==c;++a){const u=o[a];u.setValue(e,t[u.id],i)}}}const nf=/(\w+)(\])?(\[|\.)?/g;function x_(s,e){s.seq.push(e),s.map[e.id]=e}function KA(s,e,t){const i=s.name,o=i.length;for(nf.lastIndex=0;;){const a=nf.exec(i),c=nf.lastIndex;let u=a[1];const f=a[2]==="]",d=a[3];if(f&&(u=u|0),d===void 0||d==="["&&c+2===o){x_(t,d===void 0?new XA(u,s,e):new jA(u,s,e));break}else{let p=t.map[u];p===void 0&&(p=new YA(u),x_(t,p)),t=p}}}class Ac{constructor(e,t){this.seq=[],this.map={};const i=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let o=0;o<i;++o){const a=e.getActiveUniform(t,o),c=e.getUniformLocation(t,a.name);KA(a,c,this)}}setValue(e,t,i,o){const a=this.map[t];a!==void 0&&a.setValue(e,i,o)}setOptional(e,t,i){const o=t[i];o!==void 0&&this.setValue(e,i,o)}static upload(e,t,i,o){for(let a=0,c=t.length;a!==c;++a){const u=t[a],f=i[u.id];f.needsUpdate!==!1&&u.setValue(e,f.value,o)}}static seqWithValue(e,t){const i=[];for(let o=0,a=e.length;o!==a;++o){const c=e[o];c.id in t&&i.push(c)}return i}}function y_(s,e,t){const i=s.createShader(e);return s.shaderSource(i,t),s.compileShader(i),i}const qA=37297;let $A=0;function ZA(s,e){const t=s.split(`
`),i=[],o=Math.max(e-6,0),a=Math.min(e+6,t.length);for(let c=o;c<a;c++){const u=c+1;i.push(`${u===e?">":" "} ${u}: ${t[c]}`)}return i.join(`
`)}const S_=new dt;function JA(s){wt._getMatrix(S_,wt.workingColorSpace,s);const e=`mat3( ${S_.elements.map(t=>t.toFixed(4))} )`;switch(wt.getTransfer(s)){case Cc:return[e,"LinearTransferOETF"];case Ft:return[e,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",s),[e,"LinearTransferOETF"]}}function E_(s,e,t){const i=s.getShaderParameter(e,s.COMPILE_STATUS),a=(s.getShaderInfoLog(e)||"").trim();if(i&&a==="")return"";const c=/ERROR: 0:(\d+)/.exec(a);if(c){const u=parseInt(c[1]);return t.toUpperCase()+`

`+a+`

`+ZA(s.getShaderSource(e),u)}else return a}function QA(s,e){const t=JA(e);return[`vec4 ${s}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}function e1(s,e){let t;switch(e){case oS:t="Linear";break;case aS:t="Reinhard";break;case lS:t="Cineon";break;case cS:t="ACESFilmic";break;case hS:t="AgX";break;case fS:t="Neutral";break;case uS:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+s+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const _c=new X;function t1(){wt.getLuminanceCoefficients(_c);const s=_c.x.toFixed(4),e=_c.y.toFixed(4),t=_c.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${s}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function n1(s){return[s.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",s.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(ya).join(`
`)}function i1(s){const e=[];for(const t in s){const i=s[t];i!==!1&&e.push("#define "+t+" "+i)}return e.join(`
`)}function r1(s,e){const t={},i=s.getProgramParameter(e,s.ACTIVE_ATTRIBUTES);for(let o=0;o<i;o++){const a=s.getActiveAttrib(e,o),c=a.name;let u=1;a.type===s.FLOAT_MAT2&&(u=2),a.type===s.FLOAT_MAT3&&(u=3),a.type===s.FLOAT_MAT4&&(u=4),t[c]={type:a.type,location:s.getAttribLocation(e,c),locationSize:u}}return t}function ya(s){return s!==""}function M_(s,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return s.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function T_(s,e){return s.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const s1=/^[ \t]*#include +<([\w\d./]+)>/gm;function Qf(s){return s.replace(s1,a1)}const o1=new Map;function a1(s,e){let t=pt[e];if(t===void 0){const i=o1.get(e);if(i!==void 0)t=pt[i],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,i);else throw new Error("Can not resolve #include <"+e+">")}return Qf(t)}const l1=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function w_(s){return s.replace(l1,c1)}function c1(s,e,t,i){let o="";for(let a=parseInt(e);a<parseInt(t);a++)o+=i.replace(/\[\s*i\s*\]/g,"[ "+a+" ]").replace(/UNROLLED_LOOP_INDEX/g,a);return o}function A_(s){let e=`precision ${s.precision} float;
...
#define LOW_PRECISION`),e}function u1(s){let e="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===J_?e="SHADOWMAP_TYPE_PCF":s.shadowMapType===By?e="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===nr&&(e="SHADOWMAP_TYPE_VSM"),e}function h1(s){let e="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case vo:case xo:e="ENVMAP_TYPE_CUBE";break;case Uc:e="ENVMAP_TYPE_CUBE_UV";break}return e}function f1(s){let e="ENVMAP_MODE_REFLECTION";if(s.envMap)switch(s.envMapMode){case xo:e="ENVMAP_MODE_REFRACTION";break}return e}function d1(s){let e="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case Q_:e="ENVMAP_BLENDING_MULTIPLY";break;case rS:e="ENVMAP_BLENDING_MIX";break;case sS:e="ENVMAP_BLENDING_ADD";break}return e}function p1(s){const e=s.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:i,maxMip:t}}function m1(s,e,t,i){const o=s.getContext(),a=t.defines;let c=t.vertexShader,u=t.fragmentShader;const f=u1(t),d=h1(t),g=f1(t),p=d1(t),_=p1(t),y=n1(t),E=i1(a),M=o.createProgram();let S,x,D=t.glslVersion?"#version "+t.glslVersion+`
