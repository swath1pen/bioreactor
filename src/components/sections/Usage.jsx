...
// Define your GitHub user and repo at the top
        ...
        <div className="max-w-3xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
            <div className="p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all">
              <h3 className="text-xl font-bold mb-4"> Author: {githubUser} </h3>
              <ul className="list-disc list-inside text-gray-300 space-y-2">
                ...
                <li>
                  ...
                  <div className="flex gap-4 pt-2">
                    ...
                    >
                      <img
                        src={`https://raw.githubusercontent.com/${githubUser}/${repoName}/main/logos/github_logo.png`}
                        alt="GitHub"
                    ...
                    <a href="https://bsky.app/profile/swath1.bsky.social" target="_blank" rel="noopener noreferrer">
                      <img
                        src={`https://raw.githubusercontent.com/${githubUser}/${repoName}/main/logos/bluesky_logo.png`}
                        alt="Bluesky"
                    ...
                    <a href="https://scholar.google.com/citations?user=QiISpWMAAAAJ&hl=en" target="_blank" rel="noopener noreferrer">
                      <img
                        src={`https://raw.githubusercontent.com/${githubUser}/${repoName}/main/logos/google_scholar_logo.png`}
                        alt="Google Scholar"
                        className="w-8 h-8 hover:scale-110 transition"
                      />
                    </a>
                    ...
                    <a href="https://www.researchgate.net/profile/Swathi_Penumutchu" target="_blank" rel="noopener noreferrer">
                      <img
                        src={`https://raw.githubusercontent.com/${githubUser}/${repoName}/main/logos/research_gate_logo.png`}
                        alt="ResearchGate"
                        className="w-8 h-8 hover:scale-110 transition"
                      />
                    </a>
              ...
              <div className="space-y-4 text-gray-300">
                ...
                <div className="flex gap-4 pt-2">
                  ...
                  <a href="https://furstlab.github.io/BioEchemBuilds/" target="_blank" rel="noopener noreferrer">
                    <img
                      src={`https://raw.githubusercontent.com/${githubUser}/${repoName}/main/logos/bioechem_logo.png`}
                      alt="BioEchemBuilds"
                      className="w-50 h-12 hover:scale-110 transition"
                    />
                  </a>
                </div>
              </div>
